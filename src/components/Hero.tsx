  ...
  return (
    <section id='hero' className='relative min-h-screen flex items-center overflow-hidden pt-20'>
      ...
      <div className='absolute inset-0 z-0 pointer-events-none'>
        <div className='absolute top-[-10%] right-[-5%] w-[500px] h-[500px] bg-nuraya-gold/10 rounded-full blur-[100px] animate-pulse dark:bg-nuraya-gold/5' />
        <div className='absolute bottom-[10%] left-[-10%] w-[600px] h-[600px] bg-sky-blue/10 rounded-full blur-[120px] dark:bg-sky-blue/5' />
      </div>
      ...
      <div className='container mx-auto px-8 md:px-16 lg:px-20 py-12 md:py-16 relative z-10'>
        <div className='grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center'>
          ...
          <div className='lg:col-span-7 flex flex-col items-start text-left animate-fade-up'>
            ...
            <p className='text-xl md:text-2xl text-gray dark:text-gray-200 max-w-2xl mb-2'>
              <strong>Membangun makna, menyalakan harapan.</strong>
            </p>

            <p className='text-base md:text-lg text-gray-600 dark:text-gray-400 max-w-xl mb-10 leading-relaxed'>
          ...
          <div className='lg:col-span-5 relative hidden lg:block h-full min-h-[400px]'>
            <div className='absolute inset-0 flex items-center justify-center'>
              ...
              <div className='relative w-full aspect-square max-w-[500px]'>
                <div className='absolute inset-0 bg-gradient-to-tr from-nuraya-gold/20 to-sky-blue/20 rounded-full blur-3xl animate-float' />
                <div className='absolute top-1/4 right-1/4 w-32 h-32 bg-nuraya-gold rounded-full blur-2xl opacity-40 animate-glow' />
                <div className='absolute bottom-1/3 left-1/3 w-40 h-40 bg-sky-blue rounded-full blur-2xl opacity-30 animate-pulse' />
